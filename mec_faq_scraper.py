...
array JSON com as chaves: "programa", "pergunta" e "resposta".
...
# REQUEST_DELAY   = 1.5  # pausa educada entre requisições

# # Classes de spans gerados pelo Word/Office Online (devem ser ignoradas
# # como contêineres, mas seu texto interno ainda é aproveitado)
# WORD_SPAN_CLASSES = {
#     "EOP",           # End-Of-Paragraph — contém apenas &nbsp;, deve ser descartado
#     "SCXW",          # prefixo dos wrappers de parágrafo do Word
# }
...
#     """Colapsa espaços e tabs excessivos em um único espaço."""
#     return " ".join(text.split())


# def _is_eop_span(tag: Tag) -> bool:
#     """Verifica se o elemento é um marcador de fim-de-parágrafo do Word."""
#     classes = tag.get("class", [])
#     return tag.name == "span" and any("EOP" in c for c in classes)


# def _extract_paragraph_text(p_tag: Tag) -> str:
#     """
#     Extrai texto limpo de um <p>, ignorando spans EOP (&nbsp; inúteis)
#     e colapsando os spans aninhados de estilo Word em texto puro.
#     """
#     parts = []
#     for node in p_tag.descendants:
#         # Só processa nós folha de texto
#         if not isinstance(node, NavigableString):
#             continue
#         # Sobe na hierarquia para checar se algum ancestral é EOP
#         ancestor_is_eop = any(
#             isinstance(a, Tag) and _is_eop_span(a)
...
#     """
#     Converte o conteúdo de <div class="conteudo"> em texto plano,
#     preservando quebras de parágrafo como '\\n'.

#     Lida com:
#     - Parágrafos <p> normais
#     - Listas <ul>/<ol> com itens <li>
#     - Spans aninhados do Word/Office Online
#     """
#     paragraphs: list[str] = []

#     def walk(element: Tag) -> None:
#         """Caminha recursivamente pelos filhos diretos do elemento."""
...
#             elif child.name == "br":
#                 # Quebra explícita — não adiciona parágrafo vazio extra
#                 pass

#             elif child.name in ("div", "section", "blockquote", "article"):
#                 # Contêineres: desce recursivamente
#                 walk(child)

#             # tags inline (span, a, strong, em…) são tratadas dentro de <p>

#     walk(conteudo_div)

#     # Remove duplicatas consecutivas de linha em branco
#     result_lines = []
...
#     """
#     Retorna o nome do programa a partir de
...
#     """
#     Estratégia primária — padrão gov.br/MEC.

#     Estrutura identificada no DevTools:

#         <div id="content-core">
#           <ul class="toggable-content">
#             <li>               ← pode ser um agrupador extra
#               <ul>
#                 <li>
#                   <a class="toggle [open|closed]" href="...">Pergunta?</a>
#                   <div class="conteudo">
#                     <div class="ListContainerWrapper …">
#                       <p><span …>Texto da resposta…</span></p>
#                       …
#                     </div>
#                   </div>
#                 </li>
...
#     # Todos os <li> que contêm diretamente um link .toggle
#     for li in toggable.find_all("li"):
#         toggle_link = li.find("a", class_="toggle")
#         if not toggle_link:
#             continue

#         pergunta = _clean(toggle_link.get_text(" ", strip=True))
#         if not pergunta:
#             continue

#         conteudo_div = li.find("div", class_="conteudo")
#         if not conteudo_div:
#             continue

#         resposta = _extract_answer_text(conteudo_div)
#         if resposta:
#             pairs.append({"pergunta": pergunta, "resposta": resposta})
...
#     """
#     Fallback: <p><strong>Pergunta?</strong></p> seguido de <p>resposta</p>.
#     """
#     pairs = []
#     content = (
...
#                 j += 1
#             if resp_parts:
#                 pairs.append({"pergunta": text, "resposta": "\n".join(resp_parts)})
#             i = j
#         else:
#             i += 1
#     return pairs
...
#         if resp_parts:
#             pairs.append({"pergunta": pergunta, "resposta": "\n".join(resp_parts)})
#     return pairs
...
#     log.warning("  Nenhuma estratégia encontrou perguntas/respostas.")
#     return []
...
#     as chaves 'programa', 'pergunta' e 'resposta'.
#     """
#     results: list[dict] = []
...
#             log.info("  %d registro(s) adicionado(s) ao resultado.", len(results))
...
Extrai perguntas e respostas da seção "Dúvidas Frequentes" de páginas de
Programas e Ações do Ministério da Educação (gov.br/mec) e retorna um
array JSON com as chaves: "programa", "agrupamento", "pergunta" e "resposta".
...
def scrape_faq_pages(urls: list[str]) -> list[dict]:
    """
    Recebe uma lista de URLs de FAQ do MEC e retorna um array de dicts com
    as chaves 'programa', 'agrupamento', 'pergunta' e 'resposta'.
    """
    results: list[dict] = []
